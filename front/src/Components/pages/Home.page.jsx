...
const HomePage = () => {
    return (
        <>
            <div className="lg:container lg:mx-auto lg:px-40 lg:pb-8">
                <div className="lg:flex lg:justify-center lg:m-0  py-6">
                    <div className="flex md:gap-6  gap-2 justify-center bg-red-200 lg:w-3/4 lg:py-2 lg:px-8 items-center rounded-lg lg:mx-10 px-2 py-2 mx-4">
